---
title: "Regla 0x6008h: Escribí el contrato de la función antes de implementarla"
short_title: "0x6008h"
subtitle: "Disciplina de Construcción Sistemática (0x60XX) — Propuesta"
---

(0x6008h)=
# 0x6008h: Escribí el contrato de la función antes de implementarla

:::{admonition} Categoría: Disciplina de Construcción Sistemática (0x60XX) — Propuesta
:class: note
Código de regla: `0x6008h` | Soporta corrección automática: **No**
:::

:::{seealso} Reglas relacionadas
* {ref}`0x2003h` — documentación estructurada con `@param`, `@pre`, `@returns`.
* {ref}`0x3009h` — documentar explícitamente cuándo se retorna `NULL`.
:::

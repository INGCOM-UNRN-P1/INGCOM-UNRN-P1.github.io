---
title: "Regla 0x600Ch: Documentá el invariante de cada lazo"
short_title: "0x600Ch"
subtitle: "Disciplina de Construcción Sistemática (0x60XX) — Propuesta"
---

(0x600Ch)=
# 0x600Ch: Documentá el invariante de cada lazo

:::{admonition} Categoría: Disciplina de Construcción Sistemática (0x60XX) — Propuesta
:class: note
Código de regla: `0x600Ch` | Soporta corrección automática: **No**
:::

:::{seealso} Reglas relacionadas
* {ref}`0x1003h` — elegir `for` o `while` según el tipo de lazo.
* {ref}`0x000Ah` — comentarios que explican el porqué.
...
{ref}`0x1003h` (elegir bien el tipo de lazo) y en {ref}`0x000Ah`
...
* {ref}`0x000Ah` — comentarios de intención.
* {ref}`0x6008h` — contrato de la función que contiene el lazo.
* {ref}`0x100Fh` — condiciones de parada simples.

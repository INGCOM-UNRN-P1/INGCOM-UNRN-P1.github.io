...
> **NO DEBE** usarse una variable `float` o `double` como contador ni como variable de control de un lazo.
...
* {ref}`0x301Bh` — norma este antipatrón: evitar usos innecesarios de casts/flotantes.

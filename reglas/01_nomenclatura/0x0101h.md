---
title: "Regla 0x0101h: Los identificadores deben ser descriptivos"
short_title: "0x0101h"
...
:class: note
Código de regla: `0x0101h` | Soporta corrección automática: **No**
:::

:::{seealso} Refactorización asociada
* {ref}`refactorizacion-naming` — Técnicas de renombrado y criterios de nomenclatura.
:::
...
fundamento cualitativo de {ref}`0x010Bh`, que fija longitudes mínimas según
el alcance.
...
significado; además {ref}`0x010Eh` prohíbe expresamente los sufijos
numéricos.
...
* {ref}`0x010Bh` — longitud mínima proporcional al alcance del identificador.
* {ref}`0x010Eh` — prohibición de sufijos numéricos y afijos genéricos.
* {ref}`0x0105h` — los nombres de función también son identificadores.
* {ref}`0x0102h` — forma snake_case exigida a variables y argumentos.
* {ref}`0x0201h` — el buen nombre reduce la necesidad de comentarios.

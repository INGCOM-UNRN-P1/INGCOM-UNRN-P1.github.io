...
* {ref}`0x2014h` — el pseudocódigo determina cuántas funciones y de qué tipo
  hacen falta.
* {ref}`0x2016h` — la especificación (contrato) y el pseudocódigo se redactan
  juntos.
* {ref}`0x0201h` — los comentarios de intención registran el diseño previo en el
  código.

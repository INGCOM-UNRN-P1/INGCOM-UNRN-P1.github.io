---
title: "Regla 0x0014h: Prohibición de identificadores con caracteres no ASCII (acentos, ñ)"
short_title: "0x0014h"
...
| `gaff` | `gaff check archivo.c` | Regla 0x0014h: identificador no ASCII. |
...
* {ref}`0x000Eh` — funciones en `snake_case`.
* {ref}`0x000Ch` — nombres de archivo sin caracteres especiales.
* {ref}`0x0018h` — prefijos reservados del compilador.
* {ref}`0x0001h` — nombres descriptivos, siempre en ASCII.

...
| [0x1002h](0x1002h.md) | no uses el uso descontrolado de break y continue; preferí lazos con bandera de control | [Bucle infinito con salida condicionada exclusivamente por exit()](ap_0x101Ch.md) | `AP-0x101Ch` |
...
| [0x1004h](0x1004h.md) | Las condiciones complejas deben ser simplificadas o comentadas Si una | *(Sin antipatrón específico)* | — |
| [0x1005h](0x1005h.md) | no uses las condiciones ambiguas basadas en la "veracidad" (truthiness) del tipo de dato | [Comparación booleana explícita redundante](ap_0x1005h.md) | `AP-0x1005h` |
...
| [0x100Ch](0x100Ch.md) | mitigar comparaciones en estilo Yoda ('CONST == variable') | [Caso de switch sin break (Fallthrough no intencional)](ap_0x100Ch.md) | `AP-0x100Ch` |

...
* **[AP-0x400Ah: Lectura de cadenas con scanf() sin límite de ancho en buffer fijo](ap_0x400Ah.md)** — otro uso de la E/S que deja el programa en estado inválido.
:::
...
## Reglas relacionadas
* {ref}`0x4001h` — el ciclo de vida del flujo empieza en `fopen` y termina en `fclose`.

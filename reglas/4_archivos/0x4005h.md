...
* {ref}`0x4002h` — el `fread` posterior a un `fseek` también exige retorno verificado.
* {ref}`0x4004h` — validar dimensiones no exime de cerrar el recurso.
:::
...
simbólicas con nombre (ver {ref}`0x0038h`), siempre que valide el tamaño.
...
* {ref}`0x0038h` — prohibición de índices numéricos mágicos; usá constantes.
* {ref}`0x300Ch` — verificar límites de arreglos antes de acceder.
* {ref}`0x4004h` — la validación de dimensiones no reemplaza el cierre simétrico.

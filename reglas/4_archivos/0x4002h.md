...
* **[AP-0x4002h: Control de lectura con while(!feof())](ap_0x4002h.md)** — el lazo que confía en `feof` en lugar del retorno de lectura.
:::
...
canónico [AP-0x4002h](ap_0x4002h.md).

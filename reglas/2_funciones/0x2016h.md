...
| Consistencia | Se pierde la uniformidad con {ref}`0x1011h` y {ref}`0x2001h`. |
...
({ref}`0x2008h`); no hay un solo `else`.
...
* {ref}`0x1011h` — misma prohibición formulada en el bloque de control.

---
title: "Regla 0x2006h: Una aserción por cada función de prueba"
short_title: "0x2006h"
...
dominio y conecta con {ref}`0x2012h` (dead stores).
...
* {ref}`0x2009h` — la solución vive en funciones, y cada una recibe su prueba.
* {ref}`0x2002h` — sin E/S embebida, el `assert` es suficiente y limpio.
* {ref}`0x2008h` — los códigos de error se comparan con nombres simbólicos.

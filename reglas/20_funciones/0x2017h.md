...
* {ref}`0x2008h` — regla que norma este defecto: resolver con funciones bien formadas.
...
* {ref}`0x2010h` — regla que norma este defecto: no reasignar parámetros por valor.

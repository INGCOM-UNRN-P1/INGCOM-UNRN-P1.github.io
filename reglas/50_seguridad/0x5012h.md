...
`a.h` empieza, incluye `b.h`, y `b.h` vuelve a `a.h` cuyo macro ya está
definido,
...
completo** (por valor, para `sizeof` o para acceder a campos) de una cabecera
que
...
* {ref}`0x5003h` — la guarda corta la recursión, pero no arregla el diseño
  circular.

...
* {ref}`0x500Bh` — incluí `<string.h>` y `<stdio.h>` para que el compilador
  valide las firmas.
* {ref}`0x300Ch` — validá límites antes de indexar; complementa la seguridad de
  cadenas.
...
- [ ] ¿Algún `==`/`!=` tiene un `char *` o un literal entre comillas como
  operando?

---
title: "Regla 0x301Eh: Asigná NULL al puntero tras liberar un recurso opaco en el ámbito del cliente"
short_title: "0x301Eh"
...
:class: note
Código de regla: `0x301Eh` | Soporta corrección automática: **No**
...
`free()`; leerlo para compararlo contra `NULL` no es válido. Anularlo restaura
un
...
* {ref}`0x3014h` — la doble liberación es la consecuencia directa de omitir la
  anulación.
* {ref}`0x301Dh` — la opacidad hace que el puntero sea la única prueba de
  validez.

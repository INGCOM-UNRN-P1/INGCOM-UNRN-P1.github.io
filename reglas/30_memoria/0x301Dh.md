---
title: "Regla 0x301Dh: Diseñá los Tipos de Datos Abstractos utilizando punteros opacos"
short_title: "0x301Dh"
...
:class: note
Código de regla: `0x301Dh` | Soporta corrección automática: **No**
...
(`struct punto_t { int x; int y; };`), donde exponer campos es legítimo porque
no
...
* {ref}`0x301Eh` — el puntero opaco se anula en el cliente tras destruirlo.

...
Un valor de retorno `NULL` es ambiguo: puede significar "no se encontró", "no
hay
...
- **Errores diferenciados:** si hay varios motivos de `NULL`, considerá un
  `enum`
...
* {ref}`0x3001h` — todo retorno `NULL` de reserva debe verificarse en el
  llamador.

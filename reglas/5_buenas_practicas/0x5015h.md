---
title: "Regla 0x5015h: Protección obligatoria con paréntesis envolventes en expresiones de macroconstantes (#define)"
short_title: "0x5015h"
...
:class: note
Código de regla: `0x5015h` | Soporta corrección automática: **Sí**
:::

:::{seealso} Reglas relacionadas
* {ref}`0x500Ah` — la protección equivalente dentro de las macros con parámetros.
* {ref}`0x0008h` — las constantes se nombran en `MAYUSCULAS_SNAKE_CASE`.
:::
...
| :--- | :--- | :--- |
| `gaff` | `gaff check archivo.c` | Reporta `0x5015h` y `gaff fix` agrega los paréntesis. |
...
* {ref}`0x0008h` — nomenclatura de constantes en mayúsculas.

...
* **[AP-0x5014h: Invocación al intérprete de comandos con system() o popen()](ap_0x5014h.md)** — el registro asociado a esta regla en la auditoría.
:::
...
| :--- | :--- | :--- |
| `gaff` | `gaff check *.h` | Reporta `0x5014h` al detectar el ciclo en el grafo de inclusiones. |
...
* {ref}`0x5011h` — una colisión de guardas puede simular un ciclo.

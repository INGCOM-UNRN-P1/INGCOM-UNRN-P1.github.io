---
title: "Regla 0x5013h: Prohibición de declaraciones extern en archivos de implementación (.c)"
short_title: "0x5013h"
...
:class: note
Código de regla: `0x5013h` | Soporta corrección automática: **No**
:::

:::{seealso} Reglas relacionadas
* {ref}`0x0011h` — la interfaz compartida vive en la cabecera del módulo.
* {ref}`0x500Ch` — la implementación se compila aparte y se une en el enlace.
:::
...
| :--- | :--- | :--- |
| `gaff` | `gaff check archivo.c` | Reporta `0x5013h` ante una declaración `extern` en un `.c`. |
...
* {ref}`0x0011h` — la interfaz del módulo se expone mediante su cabecera.

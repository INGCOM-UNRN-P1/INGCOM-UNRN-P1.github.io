---
title: "Regla 0x7004h: No llamés exit() en funciones de biblioteca: propagá el error"
short_title: "0x7004h"
...
:class: note
Código de regla: `0x7004h` | Soporta corrección automática: **No**
...
(que decide). Se apoya en {ref}`0x7003h` (verificar y propagar retornos) y en
...
* {ref}`0x7003h` — propagación de retornos.
* {ref}`0x2005h` — responsabilidad única del módulo.
* {ref}`0x2007h` — códigos de retorno como constantes o `enum`.

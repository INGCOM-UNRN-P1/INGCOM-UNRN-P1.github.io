...
({ref}`0x0000h`) sobre la compactación. La regla es coherente con
{ref}`0x100Ah` (prohibición de asignaciones dentro de condiciones lógicas) y con
{ref}`0x1014h` (prohibición de asignaciones embebidas en el control), y las
...
comparación. La excepción que menciona {ref}`0x1014h` para bucles de lectura
...
* {ref}`0x100Ah` — prohibición general de asignaciones dentro de condiciones.
* {ref}`0x1014h` — prohibición de asignaciones embebidas en estructuras de control.
* {ref}`0x3001h` — la reserva separada permite verificar el retorno con claridad.
* {ref}`0x0000h` — la claridad es el criterio rector de esta separación.

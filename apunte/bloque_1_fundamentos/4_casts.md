...
Analizá el siguiente fragmento de código y deducí el valor final almacenado en la variable `resultado` y su tipo lógico de representación:
...
Identificá el error de diseño en el siguiente fragmento de código y explicalo desde la perspectiva de la precedencia de operadores y la conversión de tipos:
...
Explicá por qué el siguiente programa imprime "Indefinido o Inesperado" en lugar de "Correcto", analizando las reglas de conversión implícita:

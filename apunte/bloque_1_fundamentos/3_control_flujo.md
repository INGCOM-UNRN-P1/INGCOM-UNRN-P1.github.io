...
- [Compilación separada](5_compilacion.md) — Proceso de compilación
  multi-etapa y Makefile.
- [Secuencias y arreglos](../bloque_2_memoria/3_secuencias.md) —
  Arreglos de memoria estáticos y cadenas de caracteres.
- [Punteros](../bloque_2_memoria/2_punteros.md) — Punteros y
  manipulación de memoria.
- [Archivos de texto](../bloque_2_memoria/4_archivos_texto.md) —

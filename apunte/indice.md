...
*   **[](6_secuencias.md)**: Arreglos unidimensionales estáticos y gestión robusta de cadenas de caracteres (`strings`).
*   **[](7_matrices.md)**: Arreglos multidimensionales y optimización de localidad espacial en la memoria caché.
...
*   **[](14_memoria_dinamica.md)**: Alocación dinámica de recursos con `malloc`, `realloc` y `free`, junto con el análisis de fugas.
*   **[](15_aritmetica.md)**: Aritmética de direcciones física y conversión explícitamente de tipos de punteros (`casting`).
*   **[](16_punteros_funciones.md)**: Punteros a funciones y diseño de algoritmos paramétricos mediante funciones de callback.
*   **[](17_opacos.md)**: Encapsulamiento lógico riguroso mediante el ocultamiento de tipos incompletos en C.
*   **[](18_tad.md)**: Diseño y contratos de la interfaz del Tipo de Dato Abstracto (TAD) Secuencia (listas enlazadas vs arreglos).
*   **[](18b_tad_pilas_colas.md)**: Tipos de Datos Abstractos con restricciones de acceso: Pilas (Stacks), Colas (Queues) y Deques.
*   **[](19_complejidad.md)**: Análisis de eficiencia algorítmica, notación asintótica Big-O, límites de hardware y la teoría P vs NP.

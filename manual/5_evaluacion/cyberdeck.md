...
`cyberdeck` conecta la estación de trabajo docente con dispositivos periféricos (teclados macro, microcontroladores ESP32/RP2040, interfaces táctiles) para controlar en tiempo real herramientas como `slide-tools` y `meet-tools`.

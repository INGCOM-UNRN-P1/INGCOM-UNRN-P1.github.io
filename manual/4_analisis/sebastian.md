...
Ejecutá `make check-sebastian` antes de cada commit para mantener que tu código conserve el estado de aprobación.
...
- `hal (mitigación de stack overflow)` | Informes Markdown, diagnósticos Rich, JSON, actas |

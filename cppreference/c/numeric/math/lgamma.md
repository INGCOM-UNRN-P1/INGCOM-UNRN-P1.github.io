...
## Contents
  ...
  * [6 References](lgamma.html#References)
  * [7 See also](lgamma.html#See_also)
  * [8 External links](lgamma.html#External_links)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/lgamma&action=edit&section=1 "Edit section: Parameters")] Parameters

arg  |  \-  |  floating-point value   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/lgamma&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/lgamma&action=edit&section=3 "Edit section: Error handling")] Error handling
...
If the implementation supports IEEE floating-point arithmetic (IEC 60559), 
  ...
  * If the argument is a negative integer, +∞ is returned and [FE_DIVBYZERO](../fenv/FE_exceptions.html "c/numeric/fenv/FE exceptions") is raised. 
  * If the argument is ±∞, +∞ is returned. 
  * If the argument is NaN, NaN is returned. 



### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/lgamma&action=edit&section=4 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/lgamma&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
    int main(void)
    {
        [printf](../../io/fprintf.html)("lgamma(10) = %f, log(9!) = %f\n", lgamma(10),
                                                  [log](log.html)(2 * 3 * 4 * 5 * 6 * 7 * 8 * 9));
        const double pi = [acos](acos.html)(-1);
        [printf](../../io/fprintf.html)("lgamma(0.5) = %f, log(sqrt(pi)) = %f\n", [log](log.html)([sqrt](sqrt.html)(pi)), lgamma(0.5));
        // special values
        [printf](../../io/fprintf.html)("lgamma(1) = %f\n", lgamma(1));
        [printf](../../io/fprintf.html)("lgamma(+Inf) = %f\n", lgamma(INFINITY));
     
        // error handling
        errno = 0; [feclearexcept](../fenv/feclearexcept.html)([FE_ALL_EXCEPT](../fenv/FE_exceptions.html));
        [printf](../../io/fprintf.html)("lgamma(0) = %f\n", lgamma(0));
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/lgamma&action=edit&section=6 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/lgamma&action=edit&section=7 "Edit section: See also")] See also

[ tgammatgammaftgammal](tgamma.html "c/numeric/math/tgamma")(C99)(C99)(C99) |  computes gamma function   
(function) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:c/numeric/math/dsc_tgamma&action=edit)  
---|---  
[C++ documentation](../../../cpp/numeric/math/lgamma.html "cpp/numeric/math/lgamma") for lgamma  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/lgamma&action=edit&section=8 "Edit section: External links")] External links
...
Retrieved from "[https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/lgamma&oldid=172041](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/lgamma&oldid=172041)" 

...
**nan nanfnanlnand _N_**(C99)(C99)(C99)(C23)  
...
Converts the implementation-defined character string `arg` into the corresponding quiet NaN value, as if by calling the appropriate parsing function `_strtoX_`, as follows: 

  * The call nan("n-char-sequence"), where n-char-sequence is a sequence of digits, Latin letters, and underscores, is equivalent to the call /*strtoX*/("NAN(n-char-sequence)", (char**)[NULL](../../types/NULL.html));. 
  * The call nan("") is equivalent to the call /*strtoX*/("NAN()", (char**)[NULL](../../types/NULL.html));. 
  * The call nan("string"), where string is neither an n-char-sequence nor an empty string, is equivalent to the call /*strtoX*/("NAN", (char**)[NULL](../../types/NULL.html));. 



1) The parsing function is [strtof](../../string/byte/strtof.html "c/string/byte/strtof").

2) The parsing function is [strtod](../../string/byte/strtof.html "c/string/byte/strtof").

3) The parsing function is [strtold](../../string/byte/strtof.html "c/string/byte/strtof").
...
## Contents
  ...
  * [1 Parameters](nan.html#Parameters)
  * [2 Return value](nan.html#Return_value)
  * [3 Error handling](nan.html#Error_handling)
  * [4 Example](nan.html#Example)
  * [5 References](nan.html#References)
  * [6 See also](nan.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/nan&action=edit&section=1 "Edit section: Parameters")] Parameters

arg  |  \-  |  narrow character string identifying the contents of a NaN   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/nan&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/nan&action=edit&section=3 "Edit section: Error handling")] Error handling
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/nan&action=edit&section=4 "Edit section: Example")] Example
...
Run this code
    ...
    {
        double f1 = nan("1");
        [uint64_t](../../types/integer.html) f1n; [memcpy](../../string/byte/memcpy.html)(&f1n, &f1, sizeof f1);
        [printf](../../io/fprintf.html)("nan(\"1\")   = %f (%" [PRIx64](../../types/integer.html) ")\n", f1, f1n);
     
        double f2 = nan("2");
        [uint64_t](../../types/integer.html) f2n; [memcpy](../../string/byte/memcpy.html)(&f2n, &f2, sizeof f2);
        [printf](../../io/fprintf.html)("nan(\"2\")   = %f (%" [PRIx64](../../types/integer.html) ")\n", f2, f2n);
     
        double f3 = nan("0xF");
        [uint64_t](../../types/integer.html) f3n; [memcpy](../../string/byte/memcpy.html)(&f3n, &f3, sizeof f3);
        [printf](../../io/fprintf.html)("nan(\"0xF\") = %f (%" [PRIx64](../../types/integer.html) ")\n", f3, f3n);
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/nan&action=edit&section=5 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/nan&action=edit&section=6 "Edit section: See also")] See also
...
---|---  
[ NAN](NAN.html "c/numeric/math/NAN")(C99) |  evaluates to a quiet NaN of type float   
(macro constant) [[edit]](https://en.cppreference.com/mwiki/index.php?title=Template:c/numeric/math/dsc_NAN&action=edit)  
[C++ documentation](../../../cpp/numeric/math/nan.html "cpp/numeric/math/nan") for nanf, nan, nanl  
  
Retrieved from "[https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/nan&oldid=133964](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/nan&oldid=133964)" 

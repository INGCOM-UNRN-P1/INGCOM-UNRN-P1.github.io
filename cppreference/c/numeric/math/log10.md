...
1-3) Computes the common (base-_10_) logarithm of arg.
...
## Contents
  ...
  * [4 Example](log10.html#Example)
  * [5 References](log10.html#References)
  * [6 See also](log10.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/log10&action=edit&section=1 "Edit section: Parameters")] Parameters

arg  |  \-  |  floating-point value   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/log10&action=edit&section=2 "Edit section: Return value")] Return value

If no errors occur, the common (base-_10_) logarithm of arg (log10(arg) or lg(arg)) is returned. 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/log10&action=edit&section=3 "Edit section: Error handling")] Error handling
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/log10&action=edit&section=4 "Edit section: Example")] Example
...
Run this code
    ...
    int main(void)
    {
        [printf](../../io/fprintf.html)("log10(1000) = %f\n", log10(1000));
        [printf](../../io/fprintf.html)("log10(0.001) = %f\n", log10(0.001));
        [printf](../../io/fprintf.html)("base-5 logarithm of 125 = %f\n", log10(125) / log10(5));
     
        // special values
        [printf](../../io/fprintf.html)("log10(1) = %f\n", log10(1));
        [printf](../../io/fprintf.html)("log10(+Inf) = %f\n", log10(INFINITY));
     
        // error handling
        errno = 0; [feclearexcept](../fenv/feclearexcept.html)([FE_ALL_EXCEPT](../fenv/FE_exceptions.html));
        [printf](../../io/fprintf.html)("log10(0) = %f\n", log10(0));
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/log10&action=edit&section=5 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/log10&action=edit&section=6 "Edit section: See also")] See also
...
[C++ documentation](../../../cpp/numeric/math/log10.html "cpp/numeric/math/log10") for log10  
  
Retrieved from "[https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/log10&oldid=172043](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/log10&oldid=172043)" 

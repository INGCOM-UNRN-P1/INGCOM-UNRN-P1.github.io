...
## Contents
  ...
  * [6 References](copysign.html#References)
  * [7 See also](copysign.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/copysign&action=edit&section=1 "Edit section: Parameters")] Parameters

x, y  |  \-  |  floating-point values   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/copysign&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/copysign&action=edit&section=3 "Edit section: Error handling")] Error handling
...
If the implementation supports IEEE floating-point arithmetic (IEC 60559), 
  ...
  * The returned value is exact ([FE_INEXACT](../fenv/FE_exceptions.html "c/numeric/fenv/FE exceptions") is never raised) and independent of the current [rounding mode](../fenv/FE_round.html "c/numeric/fenv/FE round"). 



### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/copysign&action=edit&section=4 "Edit section: Notes")] Notes

`copysign` is the only portable way to manipulate the sign of a NaN value (to examine the sign of a NaN, [signbit](signbit.html "c/numeric/math/signbit") may also be used). 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/copysign&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
    int main(void)
    {
        [printf](../../io/fprintf.html)("copysign(1.0,+2.0)      = %+.1f\n", copysign(1.0,+2.0));
        [printf](../../io/fprintf.html)("copysign(1.0,-2.0)      = %+.1f\n", copysign(1.0,-2.0));
        [printf](../../io/fprintf.html)("copysign(INFINITY,-2.0) = %f\n",    copysign(INFINITY,-2.0));
        [printf](../../io/fprintf.html)("copysign(NAN,-2.0)      = %f\n",    copysign(NAN,-2.0));
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/copysign&action=edit&section=6 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/copysign&action=edit&section=7 "Edit section: See also")] See also
...
[C++ documentation](../../../cpp/numeric/math/copysign.html "cpp/numeric/math/copysign") for copysign  
  
Retrieved from "[https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/copysign&oldid=172004](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/copysign&oldid=172004)" 

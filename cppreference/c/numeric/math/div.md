...
Types  
| **div_t ldiv_tlldiv_timaxdiv_t**(C99)(C99)  
---  
...
imaxdiv_t imaxdiv( [intmax_t](../../types/integer.html) x, [intmax_t](../../types/integer.html) y ); |  (4)  |  (since C99)  
| |   
...
## Contents
  ...
  * [3 div_t](div.html#div_t)
  * [4 ldiv_t](div.html#ldiv_t)
  * [5 lldiv_t](div.html#lldiv_t)
  * [6 imaxdiv_t](div.html#imaxdiv_t)
    * [6.1 Notes](div.html#Notes)
    * [6.2 Example](div.html#Example)
    * [6.3 References](div.html#References)
    * [6.4 See also](div.html#See_also)
    * [6.5 External links](div.html#External_links)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/div&action=edit&section=1 "Edit section: Parameters")] Parameters

x, y  |  \-  |  integer values   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/div&action=edit&section=2 "Edit section: Return value")] Return value

If both the remainder and the quotient can be represented as objects of the corresponding type (int, long, long long, [intmax_t](../../types/integer.html), respectively), returns both as an object of type `div_t`, `ldiv_t`, `lldiv_t`, `imaxdiv_t` defined as follows: 
...
##  imaxdiv_t
    ...
    struct imaxdiv_t { [intmax_t](../../types/integer.html) quot; [intmax_t](../../types/integer.html) rem; };

or 
    
    
    struct imaxdiv_t { [intmax_t](../../types/integer.html) rem; [intmax_t](../../types/integer.html) quot; };

If either the remainder or the quotient cannot be represented, the behavior is undefined. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/div&action=edit&section=3 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/div&action=edit&section=4 "Edit section: Example")] Example
...
Run this code
    ...
    char* itoa(int n, int base, char* buf, [size_t](../../types/size_t.html) buf_size)
    {
        [assert](../../error/assert.html)(2 <= base && base <= 16 && buf && buf_size);
        div_t dv = {.quot = n};
        char* p = buf;
        do
        {
            if (!--buf_size)
                return (*buf = '\0'), buf;
            dv = div(dv.quot, base);
            *p++ = "0123456789abcdef"[[abs](abs.html)(dv.rem)];
        }
        while(dv.quot);
        if (n < 0)
            *p++ = '-';
    ...
    int main(void)
    {
        ...
        [printf](../../io/fprintf.html)("%s\n", itoa([INT_MAX](../../types/limits.html), 16, buf, sizeof buf));
        [printf](../../io/fprintf.html)("%s\n", itoa([INT_MIN](../../types/limits.html), 16, buf, sizeof buf));
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/div&action=edit&section=5 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/div&action=edit&section=6 "Edit section: See also")] See also
...
[C++ documentation](../../../cpp/numeric/math/div.html "cpp/numeric/math/div") for div  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/div&action=edit&section=7 "Edit section: External links")] External links
...
Retrieved from "[https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/div&oldid=178576](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/div&oldid=178576)" 

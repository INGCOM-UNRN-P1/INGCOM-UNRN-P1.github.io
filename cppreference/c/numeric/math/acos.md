...
7) Type-generic macro: If the argument has type long double, (3) (`acosl`) is called. Otherwise, if the argument has integer type or the type double, (2) (`acos`) is called. Otherwise, (1) (`acosf`) is called. If the argument is complex, then the macro invokes the corresponding complex function ([cacosf](../complex/cacos.html "c/numeric/complex/cacos"), [cacos](../complex/cacos.html "c/numeric/complex/cacos"), [cacosl](../complex/cacos.html "c/numeric/complex/cacos")).
...
## Contents
  ...
  * [4 Example](acos.html#Example)
  * [5 References](acos.html#References)
  * [6 See also](acos.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/acos&action=edit&section=1 "Edit section: Parameters")] Parameters

arg  |  \-  |  floating-point value   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/acos&action=edit&section=2 "Edit section: Return value")] Return value
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/acos&action=edit&section=3 "Edit section: Error handling")] Error handling
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/acos&action=edit&section=4 "Edit section: Example")] Example
...
Run this code
    ...
    int main(void)
    {
        [printf](../../io/fprintf.html)("acos(-1) = %f\n", acos(-1));
        [printf](../../io/fprintf.html)("acos(0.0) = %f 2*acos(0.0) = %f\n", acos(0), 2 * acos(0));
        [printf](../../io/fprintf.html)("acos(0.5) = %f 3*acos(0.5) = %f\n", acos(0.5), 3 * acos(0.5));
        [printf](../../io/fprintf.html)("acos(1) = %f\n", acos(1));
     
        // error handling
        errno = 0; [feclearexcept](../fenv/feclearexcept.html)([FE_ALL_EXCEPT](../fenv/FE_exceptions.html));
        [printf](../../io/fprintf.html)("acos(1.1) = %f\n", acos(1.1));
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/acos&action=edit&section=5 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/acos&action=edit&section=6 "Edit section: See also")] See also
...
[C++ documentation](../../../cpp/numeric/math/acos.html "cpp/numeric/math/acos") for acos  
  
Retrieved from "[https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/acos&oldid=150033](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/acos&oldid=150033)" 

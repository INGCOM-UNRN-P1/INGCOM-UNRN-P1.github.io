...
## Contents
  ...
  * [1 Parameters](nexttoward.html#Parameters)
  * [2 Return value](nexttoward.html#Return_value)
  * [3 Error handling](nexttoward.html#Error_handling)
  * [4 Notes](nexttoward.html#Notes)
  * [5 Example](nexttoward.html#Example)
  * [6 References](nexttoward.html#References)
  * [7 See also](nexttoward.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/nextafter&action=edit&section=1 "Edit section: Parameters")] Parameters

from, to  |  \-  |  floating-point values   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/nextafter&action=edit&section=2 "Edit section: Return value")] Return value
...
If a range error due to overflow occurs, ±[HUGE_VAL](HUGE_VAL.html), `±HUGE_VALF`, or `±HUGE_VALL` is returned (with the same sign as from). 

If a range error occurs due to underflow, the correct result is returned. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/nextafter&action=edit&section=3 "Edit section: Error handling")] Error handling

Errors are reported as specified in [`math_errhandling`](math_errhandling.html "c/numeric/math/math errhandling"). 

If the implementation supports IEEE floating-point arithmetic (IEC 60559), 

  * if from is finite, but the expected result is an infinity, raises [FE_INEXACT](../fenv/FE_exceptions.html "c/numeric/fenv/FE exceptions") and [FE_OVERFLOW](../fenv/FE_exceptions.html "c/numeric/fenv/FE exceptions"). 
  * if from does not equal `to` and the result is subnormal or zero, raises [FE_INEXACT](../fenv/FE_exceptions.html "c/numeric/fenv/FE exceptions") and [FE_UNDERFLOW](../fenv/FE_exceptions.html "c/numeric/fenv/FE exceptions"). 
  * in any case, the returned value is independent of the current rounding mode 
  * if either from or `to` is NaN, NaN is returned. 



### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/nextafter&action=edit&section=4 "Edit section: Notes")] Notes

[POSIX specifies](https://pubs.opengroup.org/onlinepubs/9699919799/functions/nextafter.html) that the overflow and the underflow conditions are range errors ([errno](../../error/errno.html "c/error/errno") may be set). 
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/nextafter&action=edit&section=5 "Edit section: Example")] Example
...
Run this code
    ...
    int main(void)
    {
        ...
        [printf](../../io/fprintf.html)("The next representable float after %.2f is %.20g (%a)\n", from1, to1, to1);
     
        float from2 = 1, to2 = nextafterf(from2, 2);
        [printf](../../io/fprintf.html)("The next representable float after %.2f is %.20f (%a)\n", from2, to2, to2);
     
        double from3 = nextafter(0.1, 0), to3 = 0.1;
        [printf](../../io/fprintf.html)("The number 0.1 lies between two valid doubles:\n"
               "    %.56f (%a)\nand %.55f  (%a)\n", from3, from3, to3, to3);
     
        ...
        [printf](../../io/fprintf.html)("Using nextafter, next float after %.2f (%a) is %.20g (%a)\n",
               from1, from1, x, x);
        x = nexttowardf(from1, dir);
        [printf](../../io/fprintf.html)("Using nexttoward, next float after %.2f (%a) is %.20g (%a)\n",
               from1, from1, x, x);
     
        // special values
        {
            ...
            double from4 = [DBL_MAX](../../types/limits.html), to4 = nextafter(from4, INFINITY);
            [printf](../../io/fprintf.html)("The next representable double after %.2g (%a) is %.23f (%a)\n",
                   from4, from4, to4, to4);
            if([fetestexcept](../fenv/fetestexcept.html)([FE_OVERFLOW](../fenv/FE_exceptions.html))) [puts](../../io/puts.html)("   raised FE_OVERFLOW");
            if([fetestexcept](../fenv/fetestexcept.html)([FE_INEXACT](../fenv/FE_exceptions.html))) [puts](../../io/puts.html)("   raised FE_INEXACT");
        } // end FENV_ACCESS block
     
        float from5 = 0.0, to5 = nextafter(from5, -0.0);
        [printf](../../io/fprintf.html)("nextafter(+0.0, -0.0) gives %.2g (%a)\n", to5, to5);
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/nextafter&action=edit&section=6 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/nextafter&action=edit&section=7 "Edit section: See also")] See also

[C++ documentation](../../../cpp/numeric/math/nextafter.html "cpp/numeric/math/nextafter") for nextafter  
---  
  
Retrieved from "[https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/nextafter&oldid=172054](https://en.cppreference.com/mwiki/index.php?title=c/numeric/math/nextafter&oldid=172054)" 

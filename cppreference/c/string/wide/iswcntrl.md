...
## Contents
  ...
  * [5 References](iswcntrl.html#References)
  * [6 See also](iswcntrl.html#See_also)

  
---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/string/wide/iswcntrl&action=edit&section=1 "Edit section: Parameters")] Parameters

ch  |  \-  |  wide character   
---|---|---  
  
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/string/wide/iswcntrl&action=edit&section=2 "Edit section: Return value")] Return value

Non-zero value if the wide character is a control character, zero otherwise. 

### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/string/wide/iswcntrl&action=edit&section=3 "Edit section: Notes")] Notes
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/string/wide/iswcntrl&action=edit&section=4 "Edit section: Example")] Example
...
Run this code
    ...
    int main(void)
    {
        ...
        [printf](../../io/fprintf.html)("In the default locale, iswcntrl(%#x) = %d\n", c, !!iswcntrl(c));
        [setlocale](../../locale/setlocale.html)([LC_ALL](../../locale/LC_categories.html), "en_US.utf8");
        [printf](../../io/fprintf.html)("In Unicode locale, iswcntrl(%#x) = %d\n", c, !!iswcntrl(c));
    }
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/string/wide/iswcntrl&action=edit&section=5 "Edit section: References")] References
...
### [[edit](https://en.cppreference.com/mwiki/index.php?title=c/string/wide/iswcntrl&action=edit&section=6 "Edit section: See also")] See also
...
---|---  
[C++ documentation](../../../cpp/string/wide/iswcntrl.html "cpp/string/wide/iswcntrl") for iswcntrl  
ASCII values  | characters  |  [`iscntrl`](../byte/iscntrl.html "c/string/byte/iscntrl")  
**`iswcntrl`** |  [`isprint`](../byte/isprint.html "c/string/byte/isprint")  
...
Retrieved from "[https://en.cppreference.com/mwiki/index.php?title=c/string/wide/iswcntrl&oldid=159125](https://en.cppreference.com/mwiki/index.php?title=c/string/wide/iswcntrl&oldid=159125)" 

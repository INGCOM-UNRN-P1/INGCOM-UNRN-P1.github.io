...
Para utilizar GCC, debés instalar el compilador y configurar las variables de entorno de tu sistema operativo.

*   **Windows**: Seguí el paso a paso de la [Guía de Instalación del Compilador](compilador.md) para configurar MinGW-w64 y la variable `PATH`.
*   **Visual Studio Code**: Consultá la [Guía de VSCode](vscode.md) para configurar tu editor de código.

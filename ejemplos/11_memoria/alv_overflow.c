...
void consumi_stack(long long counter)
{
    ...
    stack_eater[0] =
        'a'; // por si el compilador quiere optimizar la creación del arreglo.
...
int main()
{
    ...
    printf("Para que funcione como se espera, limita la memoria virtual antes "
           "de ejecutarlo.\n");
    printf("Ejemplo para un límite de 200 MB:\n");
    printf("  1. Compila el código: gcc stack_overflow.c -o stack_overflow\n");
    printf("  2. Ejecuta con el límite: ulimit -s unlimited && ulimit -v "
           "204800 && ./stack_overflow\n\n");

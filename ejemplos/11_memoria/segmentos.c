...
int main(void)
{
    ...
    direcciones[count++] =
        (informacion_t){.direccion = (void *)main,
                        .descripcion = "Codigo (Segmento Text: main)"};

    direcciones[count++] =
        (informacion_t){.direccion = (void *)literal,
    ...
    direcciones[count++] =
        (informacion_t){.direccion = (void *)&estatica,
                        .descripcion = "estatica global (Segmento Data)"};

    direcciones[count++] =
        (informacion_t){.direccion = obtener_direccion_estatica(),
    ...
    if (dinamica != NULL)
    {
        *dinamica = 76;
        direcciones[count++] =
            (informacion_t){.direccion = (void *)dinamica,

...
int main()
{
    ...
    // En muchos compiladores, se colocarán en la memoria (stack) de forma
    // contigua, aunque el orden exacto (ascendente o descendente) no está
    // garantizado.
    int antes = 99;
    int objetivo = 10;
    int despues = 111;
    ...
    *(puntero - 1) =
        777; // Modificamos lo que creemos que es 'despues' o 'antes'

    printf("Modificando el 'vecino' siguiente a 555...\n");
    *(puntero + 1) =
        555; // Modificamos lo que creemos que es 'antes' o 'despues'
    printf("\n");

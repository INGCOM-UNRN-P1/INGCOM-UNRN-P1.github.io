...
// Suma de matrices
void sumar_matrices(int a[FILAS][COLS], int b[FILAS][COLS],
...
void multiplicar_escalar(int mat[FILAS][COLS], int escalar,
                         int resultado[FILAS][COLS])
{
    for (int i = 0; i < FILAS; i++)
    {
...
int main(void)
{
    int a[FILAS][COLS] = {{1, 2, 3}, {4, 5, 6}, {7, 8, 9}};

    int b[FILAS][COLS] = {{9, 8, 7}, {6, 5, 4}, {3, 2, 1}};

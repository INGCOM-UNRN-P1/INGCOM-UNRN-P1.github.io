...
Implementar las funciones para convertir la temperatura en grados centígrados en
Fahrenheit como
...
Implementar una función que reciba un número entero e indique si el mismo es
...
Implementar una función que haga la suma entre dos números enteros sin hacer la
...
### 8. Suma en rango
Implementar una función que sume los números enteros comprendidos entre dos
cotas.
...
### 9. Múltiplos de
Escribir una función que retorne `true` si un número entero es múltiplo de otro,
...
Implementar una función que, usando lazos, permita obtener el factorial de un
...
Implementar una función que obtenga, de manera aritmética, la suma de los

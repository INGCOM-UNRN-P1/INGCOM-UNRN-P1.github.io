...
Solicitar un número de filas `n` y mostrar el triángulo de Pascal calculando cada valor a partir del anterior en la misma fila, utilizando únicamente variables y lazos anidados.  

...
Estos ejercicios tienen como fin practicar el uso de la indirección múltiple mediante punteros dobles y la abstracción mediante punteros a funciones para implementar callbacks y genericidad en C.

### Capítulos de Apunte Correspondientes
- {ref}`capitulo-punteros-funciones`

### Cuestiones de Estilo Aplicables
- **Uso de aserciones en punteros:** Validá siempre que los punteros dobles y de función no sean `NULL` antes de desreferenciarlos o invocarlos (ver {ref}`0x2009h`).
- **Definición de alias:** Empleá `typedef` para declarar firmas de punteros a funciones legibles en tus programas (ver reglas en {ref}`0x0001h`).
